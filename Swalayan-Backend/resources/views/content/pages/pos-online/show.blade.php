            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <label class="col-sm-1 col-form-label">:</label>
                        <label
                            class="col-sm-8 col-form-label">{{ $kasir = $transaksi->kasir ? $transaksi->kasir->nama : 'Kasir Deleted' }}</label>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">Nama Pelanggan</label>
                        <label class="col-sm-1 col-form-label">:</label>
                        <label
                            class="col-sm-8 col-form-label">{{ $pelanggan = $transaksi->pelanggan ? $transaksi->pelanggan->nama : 'No Pelanggan Data' }}</label>
                    </div>
                </div>
            </div>
        </div>
