...
@section('content')
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Produk/</span> Create</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-floating-outline">
                                <input name="nama_produk" value="{{ old('nama_produk') }}" type="text"
                                    class="form-control" id="floatingInput" placeholder="Ultra Milk Rasa Cokelat 250 ml"
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-floating-outline">
                                <input name="harga_produk" value="{{ old('harga_produk') }}" type="number"
                                    class="form-control" id="floatingInput" placeholder="6000"
                                    aria-describedby="floatingInputHelp" />
                        ...
                        <div class="mb-3">
                            <select name="kategori_id" id="largeSelect" class="form-select form-select-lg">
                                ...
                                @foreach ($kategoris as $kategori)
                                    <option value="{{ $kategori->id_kategori }}" @selected(old('kategori_id') == $kategori->id_kategori)>
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-floating-outline">
                                <textarea name="deskripsi" class="form-control h-px-100" id="exampleFormControlTextarea1"
                                    placeholder="Ultra Milk Rasa Cokelat adalah produk susu...">{{ old('deskripsi') }}</textarea>
