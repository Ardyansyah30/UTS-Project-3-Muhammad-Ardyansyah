                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <select name="role" id="largeSelect" class="form-select form-select-lg">
                                ...
                                <option value="Inventaris" @selected(old('role') == 'Inventaris')>Inventaris</option>
            ...
            <div class="col-xl-10">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-floating form-floating-outline">
                                <input name="nama" value="{{ old('nama') }}" type="text" class="form-control"
                                    id="floatingInput" placeholder="Muhammad Ardyansyah"
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-floating-outline">
                                <input name="nik" value="{{ old('nik') }}" type="text" class="form-control"
                                    id="floatingInput" placeholder="14030xxxxxxxxxx" aria-describedby="floatingInputHelp" />
                        ...
                        <div class="mb-3">
                            <div class="form-floating form-floating-outline">
                                <input name="no_hp" value="{{ old('no_hp') }}" type="text" class="form-control" id="floatingInput"
                                    placeholder="08xxxxxxxx" aria-describedby="floatingInputHelp" />
